...
<body onload="window.print()">
    <div class="p-8">
        ...
        <div class="mb-8">
            <p class="font-semibold text-lg text-center mb-4">FINAL ALLOTMENT LETTER</p>

            <p class="mb-4">Dear Sir/Madam,</p>

            <p class="mb-4">With reference to your application dated <?= date('d/m/Y', strtotime($application['created_at'])) ?>, we are pleased to allot you the following unit in Executive Heights:</p>
            ...
            <p class="mb-4">This allotment is final and subject to the following terms and conditions:</p>
