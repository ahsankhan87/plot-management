...
<div class="container mx-auto p-4">
    ...
    <form method="post" action="<?= base_url('/permission/edit/' . $permission['id']) ?>" class="space-y-4">
        <div>
            <label class="block mb-1">Key</label>
            <input type="text" name="key" class="border rounded w-full px-3 py-2" value="<?= old('key', $permission['key']) ?>">
        ...
        <div>
            ...
            <input type="text" name="description" class="border rounded w-full px-3 py-2" value="<?= old('description', $permission['description']) ?>">
