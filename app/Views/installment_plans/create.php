...
<div class="container mx-auto max-w-lg p-6 bg-white rounded shadow">
    <h2 class="text-2xl font-bold mb-6 text-gray-800">Add Installment Plan</h2>
    <form method="post" action="<?= site_url('/installmentplans/store') ?>" class="space-y-5">
        <!-- <div>
        ...
        <div>
            ...
            <input type="number" name="tenure_months" required class="border rounded w-full px-3 py-2">
        </div>
        <div>
            <label class="block mb-1 text-gray-700">Down Payment (%)</label>
            <input type="number" name="down_payment_pct" required class="border rounded w-full px-3 py-2" step="0.01">
        </div>
        <div>
            <label class="block mb-1 text-gray-700">Markup (%)</label>
            <input type="number" name="markup_pct" required class="border rounded w-full px-3 py-2" step="0.01">
        </div>
        <div>
            <label class="block mb-1 text-gray-700">Schedule Rule (JSON)</label>
            <textarea name="schedule_rule_json" class="border rounded w-full px-3 py-2"></textarea>
        </div>
